...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/js/webuipopover/jquery.webui-popover.min.css">
        <link rel="stylesheet" href="/js/izitoast/css/iziToast.min.css">
        <link rel="stylesheet" href="/js/zoom/zoom.css">
        <link rel="stylesheet" href="/js/jpcard/card.css">
        ...
        <div class="main-sidebar">
            ...
            <div class="sidebar-inner">
                <ul class="icon-menu">
                    ...
                    <li>
                        <a href="{{route('product.shoppingCart')}}" id="open-cart"><i data-feather="shopping-cart"></i><span class="cart-items">{{ Session::has('cart') ? Session::get('cart')->totalQty : '' }}</span></a>
                    </li>            <!-- Search trigger -->
                    <li>
                ...
                <ul class="category-menu">
                    <li>
                        <a href="products.html">
                            <span>Products</span> <!--img src="assets/images/icons/living.svg" alt=""-->
        ...
        <div class="cart-quickview">
            <div class="inner">
                ...
                <div class="cart-action">
                    ...
                    <a href="cart.html" class="button primary-button upper-button raised is-bold">
                        <span>Open Cart</span>
                    </a>
                </div>
                <!-- Cart quickview body -->
                <div class="cart-body">
                    <ul class="shopping-cart-items">
                        <!-- Item -->
                        <li class="clearfix">
                            <img src="/images/products/office5.jpg" alt="" />
                        ...
                        <!-- Item -->
                        <li class="clearfix">
                            <img src="assets/images/products/kids2.jpg" alt="" />
                            <span class="item-meta">
                                <span class="item-name">Rabbit Lamp</span>
                                <span class="item-price">$43,47</span>
                            </span>
                            <span class="quantity">
                                <input class="input is-rounded" type="number" value="3">
                            </span>
                    ...
                    <div class="columns category-header">
                        <div class="column is-10 is-offset-1 is-tablet-landscape-padded">
                            ...
                            <div class="listing-controls">
                                ...
                                <!-- Sort -->
                                <div class="sort-box">
                                    <div class="sort-box-select default card">
                                       {!! $products->links(); !!}
                        ...
                        {{Session::get('success')}}
                            ...
                            <div class="columns is-product-grid is-multiline">
                               ...
                               <!-- <div class="column is-9">
                                    <div class="flat-card is-long">
                                        <div class="left-image is-md">
                                            <img src="/images/products/modern-table.png" alt="">
                                        </div>
                               ...
                               <!-- <div class="column is-3">
                                    <div class="flat-card">
                                        <div class="image">
                                            <img src="/images/products/blue-seat.png" alt="">
                                        </div>
                                        <div class="product-info has-text-centered">
                               ...
                               <!-- <div class="column">
                                ...
                                <!--<div class="column is-3">
                                    <div class="flat-card">
                                        <div class="image">
                                            <img src="assets/images/products/dark-seat.jpg" alt="">
                                        </div>
                                        <div class="product-info has-text-centered">
                                ...
                                <div class="column is-6">
                                    <div class="flat-card is-long">
                                        ...
                                        <div class="product-info">
                                            <a href="product.html"><h3 class="product-name featured-md">{{$product->title}}</h3></a>
                                        ...
                                        <div class="actions">
                                            <a href="{{route('product.addToCart',['id'=>$product->id])}}"><div class="add"><i data-feather="shopping-cart" class="has-simple-popover" data-content="Add to Cart" data-placement="top"></i></div></a>
                                            <div class="like"><i data-feather="heart" class="has-simple-popover" data-content="Add to Wishlist" data-placement="top"></i></div>
                                        </div>
                                    </div>
