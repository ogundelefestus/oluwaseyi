                        ...
                        <div class="column is-10 is-offset-1 is-tablet-landscape-padded">
                            ...
                            <div class="is-categories-grid">
                                ...
                                <div class="tile is-ancestor">
                                    <div class="tile is-vertical is-8">
                                        <div class="tile">
                                            <div class="tile is-parent is-vertical">
                                                <!-- Accessories Tile -->
                                                <article class="tile is-child has-background-image" data-background="images/bg/images.jpg" onClick="return true">
                                                    <div class="tile-content is-small">
                                                        ...
                                                        <!-- View category link -->
                                                        <a href="{{route('product.index')}}" class="action">
                                                            <span>Discover</span> 
                                                ...
                                                <!-- Kitchen Tile -->
                                                <article class="tile is-child has-background-image" data-background="/images/bg/index.jpg" onClick="return true">
                                                    <div class="tile-content is-small">
                                            ...
                                            <div class="tile is-parent">
                                                <article class="tile is-child has-min-height has-background-image" data-background="/images/bg/indexh.jpg" onClick="return true">
                                        ...
                                        <!-- Kids Tile -->
                                        <div class="tile is-parent">
                                            <article class="tile is-child is-danger has-min-height has-background-image" data-background="/images/bg/cloth3.jpg" onClick="return true">
                                                <div class="tile-content">
                                                    <h2 class="shop-category">Cloth</h2>
                                                    <div class="divider"></div>
                                    ...
                                    <!-- Office Tile -->
                                    <div class="tile is-parent">
                                        <article class="tile is-child has-background-image" data-background="/images/bg/cloth.jpg" onClick="return true">
                                            <div class="tile-content">
