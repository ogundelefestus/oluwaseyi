    ...
    <body>
        ...
        <div class="main-sidebar">
            <div class="sidebar-brand">
                <a href="index.html"><img src="/images/logo/nephos.svg" alt=""></a>
            </div>
        ...
        <div class="shop-wrapper has-background-image">
            ...
            <div class="slider-wrapper">
                <div class="fullscreen-slick">
                    <div class="full-slide has-background-image" data-background="/images/bg/office9.png"></div>
                    <div class="full-slide has-background-image" data-background="/images/bg/house1.png"></div>
                    <div class="full-slide has-background-image" data-background="/images/bg/kitchen2.jpg"></div>
                    <div class="full-slide has-background-image" data-background="/images/bg/office9.png"></div>
                </div>
            </div>
        </div>
