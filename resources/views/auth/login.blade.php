...
<html lang="en">
    <head>
        ...
        <title> Oluwaseyi Stores || Login</title>
                                ...
                                <div class="columns is-gapless is-flex-mobile">
                                    ...
                                    <div class="column is-6 has-text-centered image-column is-padded">
                                        <div class="store-wrapper">
                                            <img src="/images/logo/nephos-white.svg" alt="">
                                            <div class="title">
                                              Seyi Stores
                                            </div>
                                    ...
                                    <div class="column is-6 is-mobile-padded">
                                        ...
                                        <div class="tabs-wrapper animated-tabs">
                                            ...
                                            <div id="login" class="navtab-content is-active">
                                                <form method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <div class="control {{ $errors->has('email') ? ' has-error' : '' }} ">
                                                        ...
                                                        <input  class="input" placeholder id="email" type="email"  name="email" value="{{ old('email') }}" required autofocus>
                                            ...
                                            <input type="password" class="input"  id="password" type="  name="password" required>
                                                  ...
                                                  @endif
                                                    ...
                                                    <div class="control">
                                                        <label class="checkbox-wrap is-small">
                                                            <input id="house" type="checkbox" class="d-checkbox" checked name="remember" {{ old('remember') ? 'checked' : '' }} >
                                                            <span></span>
                                                            <small>Remember me?</small>&nbsp;&nbsp;&nbsp;&nbsp;
                                                             <small>Don't Have an account?<a href="{{route('register')}}">Sign Up Instead!</a></small>
                                                        </label>
                                                    </div>
                                                    <!-- Form Submit -->
